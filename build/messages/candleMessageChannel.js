...
var candlesController_1 = require("../controllers/candlesController");
(0, dotenv_1.config)();
var CandleMessageChannel = /** @class */ (function () {
    function CandleMessageChannel(server) {
        this._candleCtrl = new candlesController_1.default();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, (0, amqplib_1.connect)(process.env.AMQP_SERVER || 'amqp://henrique:gtcanime@localhost:5672')];
                    case 1:
                        connection = _b.sent();
                        _a = this;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        this._channel.consume('candles', function (msg) { return __awaiter(_this, void 0, void 0, function () {
                            var candleObj, candle;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        candleObj = JSON.parse(msg.content.toString('utf-8'));
